// k3.cpp: определ€ет точку входа дл€ консольного приложени€.
//
...
int main() {
	...
	/*	for (double i = 0; i < 50; i++)
		{*/
			...
			if (n < 98){
				cout << " орень системы уравнени€ по теореме Ќьютона: x = ќтсутствует\n";
			}
			else
			{
cout << " орень системы уравнени€ по теореме Ќьютона: x =" << x << "\n";
			}
	...
	//}
		...
		if (i>=99)cout << " орень системы уравнени€ итарационый спуск отсутсвует количество итер= " << i << "\n\n";
		else	cout << " орень системы уравнени€ итарационый спуск : x = " << x << "количество итер= " << i <<  "\n\n";
