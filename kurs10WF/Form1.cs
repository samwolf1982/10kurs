...
namespace kurs5WF
{
   ...
   // cf перенос  zf zero sf знак of переполнение
        ...
        Dictionary<string, int> arrlabel = new Dictionary<string, int>();
        int counter = 0;
        public Form1()
        {
            InitializeComponent();
      ...
      string[] str = allcomands[counter];
          ...
          //  if (counter == 0) return;
                                                ...
                                                if (str[0] == "clt")      // преривание
                                                {
                                                    ...
                                                    if (str[0] == "segment")      // преривание
                                                    {
                                                        ...
                                                        if (str[0] == "push")      // куда
                                                        {
                                                            if (stack.Count > 2)
                                                            {
                                                                //String[] s = new String[] { "ihr", "3" };
                                                                   //    parsestringINT(s);
                                                                   //    allcomands.Insert(counter, allcomandsIHR[counter]);
                                                                    //MessageBox.Show("");
                                                                throw new System.ArgumentException("переполнение стека"); 
                                                            ...
                                                            //    showrReg();
                                                                ...
                                                                if (str[0] == "cmp")      //откуда
                                                                {
                                                                    ...
                                                                    if (str[0] == "cmc")      // revers  flag CF
                                                                    {
                                                                        CF = CF == false ? true : false;

                                                                    }
                                                                    else
                                                                        if (str[0] == "label")      // revers  flag CF
                                                                        {

                                                                             try
                                                                            {
                                                                                 arrlabel.Add(str[1], counter-1);
                                                                                     SF = true;
                                                                            }
                                                                            catch (Exception)
                                                                            {
                                                                            ...
                                                                            if (str[0] == "js")      // revers  flag CF
                                                                            {

                                                                                if (SF == true)
                                                                                {
                                                                                    counter = arrlabel[str[1]];
                                                                                    mover(); SF = false;
                                                                                }
                                                                                else{
                                                                                   // counter;
            ...
            if (errstat != true)
            {
                ...
                richTextBox2.Text = "";
               richTextBox2.Text = (res += richTextBox2.Text);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (counter > allcomands.Count-1) return;
           // timer1.Start();
         //   timer2.Start();
